  ...
  methods: {
    ...
    maskdelete(e){
      ...
      wx.getStorage({
        ...
        success(res){
         wx.request({
           url: getApp().globalData.apiUrl+'/item/personal/'+e.detail.task.id,
           method:"DELETE",
           header: {
             'Accept': '*/*',
             'Content-Type': 'application/x-www-form-urlencoded',
    ...
    maskchange(e){
      ...
      wx.getStorage({
        ...
        ,
           wx.request({
            url: getApp().globalData.apiUrl+'/item/personal/visibility',
            method:"POST",
            header: {
              'Accept': '*/*',
              'Content-Type': 'application/x-www-form-urlencoded',
            ...
            data:{
              "itemId":that.data.task.id,
              "visibility":that.data.task.visibility,
            },
            success(res){
              console.log("修改可见度成功")
            }})
